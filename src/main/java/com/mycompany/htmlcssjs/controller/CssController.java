...
public class CssController {
   ...
   public String exam01WhereCss() {
      log.info("exam01_where_css() 실행");
      return "css/exam01WhereCss";
   }
   ...
   @RequestMapping("/exam10_floatLayout")
   public String exam10FloatLayout() {
      log.info("exam10FloatLayout() 실행");
      return "css/exam10_floatLayout";
   }
   ...
   @RequestMapping("/exam12_flexLayout")
   public String exam12FlexLayout() {
      log.info("exam12FlexLayout() 실행");
      return "css/exam12_flexLayout";
   }
