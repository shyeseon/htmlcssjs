...
public class JavaScriptController {
	...
	@RequestMapping("/exam13_spring")
	public String exam13Spring() {
		log.info("exam13Spring() 실행");
		return "javascript/exam13_spring"; 
	}
